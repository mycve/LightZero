...
启动方式：
    单卡: python zoo/board_games/chinesechess/config/cchess_gumbel_muzero_config.py
    多卡: torchrun --nproc_per_node=8 zoo/board_games/chinesechess/config/cchess_gumbel_muzero_config.py
"""
...
cchess_gumbel_muzero_config = dict(
    exp_name=f'data_gumbel_muzero/cchess_gumbel_muzero_ns{num_simulations}_seed0',
    env=dict(
...
if __name__ == "__main__":
    """
    单卡训练:
        python zoo/board_games/chinesechess/config/cchess_gumbel_muzero_config.py
    
    多卡 DDP 训练:
        torchrun --nproc_per_node=8 zoo/board_games/chinesechess/config/cchess_gumbel_muzero_config.py
    """
