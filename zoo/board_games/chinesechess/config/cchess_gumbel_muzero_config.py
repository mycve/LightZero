...
cchess_gumbel_muzero_config = dict(
    exp_name=f'data_gumbel_muzero/cchess_gumbel_muzero_{gpu_num}gpu_actors{n_actors}_envs{envs_per_actor}_ns{num_simulations}_seed0',
    env=dict(
